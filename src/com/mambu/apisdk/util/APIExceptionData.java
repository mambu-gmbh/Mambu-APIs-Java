...
public class APIExceptionData {
	...
	static {
		...
		API_ERROR_CODES_MAP.put(DEBITS_DO_NOT_MATCH_CREDITS, 603); // 603 ÊDEBITS_DO_NOT_MATCH_CREDITS
		API_ERROR_CODES_MAP.put(INVALID_JOURNAL_ENTRY_DATE, 604); // 604 ÊINVALID_JOURNAL_ENTRY_DATE
		API_ERROR_CODES_MAP.put(GL_ACCOUNT_IS_HEADER, 605); // 605 ÊGL_ACCOUNT_IS_HEADER
		API_ERROR_CODES_MAP.put(GL_ACCOUNT_DOES_NOT_SUPPORT_MANUALLY_ENTRIES, 606); // 606
																					// ÊGL_ACCOUNT_DOES_NOT_SUPPORT_MANUALLY_ENTRIES
